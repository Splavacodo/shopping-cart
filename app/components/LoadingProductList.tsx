    ...
    return (
        <div className="grid gap-8 [grid-template-columns:repeat(auto-fill,minmax(300px,1fr))]">
            <div className="flex flex-col w-[300px] h-[400px] border-1 border-zinc-700 rounded-lg">
                ...
                <div className="h-1/8 flex justify-center items-center gap-2">
                    <div className="rounded-sm bg-zinc-700 w-3/10 h-1/2 animate-pulse anim-delay-450"></div>
                    <div className="rounded-sm bg-zinc-700 w-3/10 h-1/2 animate-pulse anim-delay-600"></div>
                </div>
            </div>
